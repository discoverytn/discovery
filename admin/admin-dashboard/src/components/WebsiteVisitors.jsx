...
function WebsiteVisitors() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const explorersResponse = await axios.get('http://192.168.142.72:3000/admin/explorer');
        console.log('Explorers response:', explorersResponse);

        const businessResponse = await axios.get('http://192.168.142.72:3000/admin/business');
