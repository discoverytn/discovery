...
const getMessages = async (req, res) => {
    ...
    console.log('Explorer ID:', explorer_idexplorer);
    console.log('Business ID:', business_idbusiness);
    ...
    try {
      ...
      const formattedMessages = messages.map((msg) => ({
        ...msg.toJSON(),
        explorerName: msg.Explorer ? msg.Explorer.username : db.Explorer.username,
