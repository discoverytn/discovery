...
const BusinessProfileScreen = () => {
  ...
  useEffect(() => {
    const fetchBusinessData = async () => {
      try {
        const response = await axios.get(`http://192.168.26.72:3000/business/${business.id}`);
  ...
  useEffect(() => {
    const fetchBusinessPosts = async () => {
      try {
        const response = await axios.get(`http://192.168.26.72:3000/business/${business.id}/posts`);
        if (response.status === 200) 
    ...
    const fetchBusinessEvents = async () => {
      try {
        const response = await axios.get(`http://192.168.26.72:3000/business/${business.id}/events`);
        if (response.status === 200) {
  ...
  const deleteBusinessPost = async (postId, token) => {
    try {
      const response = await fetch(`http://192.168.26.72:3000/posts/business/delete/${postId}`, {
        method: 'DELETE',
        headers: {
