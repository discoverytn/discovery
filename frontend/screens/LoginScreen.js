...
const LoginScreen = () => {
  ...
  const sendResetCode = async () => {
    try {
      const endpoint = `http://192.168.1.8:3000/auth/send-reset-code`;
  ...
  const verifyResetCode = async () => {
    try {
      const endpoint = `http://192.168.1.8:3000/auth/verify-code`;
  ...
  const resetPassword = async () => {
    ...
    try {
      const endpoint = `http://192.168.1.8:3000/auth/reset-password`;
